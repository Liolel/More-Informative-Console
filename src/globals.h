...
namespace MICGlobals
{
	...
	extern bool readEffectCaster;     //Enable/Disabling reading the caster entry for active effects. Used to prevent an infinite loop of reading Effect->Caster->Effect->Caster
