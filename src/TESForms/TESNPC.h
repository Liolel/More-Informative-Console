...
void GetActorValue(ExtraInfoEntry* resultArray, RE::Actor* actor, RE::Actor::ACTOR_RUNTIME_DATA runTimeData, int id, priority actorValuePriority);  //Get the value for a specific actor value
